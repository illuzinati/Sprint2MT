...
public class Player {
    ...
    // Declare a class-level variable to store the player's name
    private String playerName;

    // Declare a class-level variable to store the player's level
    ...
    public void setName(String newName) {
        // Save the new name in the playerName variable
        this.playerName = newName;

        // Inform the user that the name has been changed
        System.out.println("Your name is now " + playerName);
    }
    ...
    // Assuming there's a playerLevel variable in your class
